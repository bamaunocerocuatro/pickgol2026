  ...
  return (
    <main className="min-h-screen bg-[#020810] max-w-md mx-auto pb-20">
      ...
      <div style={{ background: 'linear-gradient(160deg,#0d0d1a,#1a1a2e,#16213e)', borderBottom: '1px solid rgba(200,170,110,0.2)' }} className="px-4 pt-4 pb-4">
        ...
        <h1 className="font-condensed text-3xl font-black mb-1" style={{ color: '#C8AA6E' }}>📋 Todas las jugadas</h1>
        {bloqueado && (
          <div className="text-xs mt-1" style={{ color: 'rgba(210,185,130,0.55)' }}>
      ...
      <div className="px-4 py-4">
        ...
        {/* NO BLOQUEADO — jugadas ocultas */}
        {!bloqueado && (
          <div className="rounded-2xl p-6 text-center" style={{ background: '#0D1B3E', border: '1px solid rgba(200,170,110,0.2)' }}>
            <div className="text-5xl mb-4">🔒</div>
            <div className="font-condensed text-xl font-black mb-2" style={{ color: '#C8AA6E' }}>
              Las jugadas están ocultas
            </div>
            <p className="text-sm mb-4" style={{ color: 'rgba(210,185,130,0.65)', lineHeight: '1.6' }}>
              Para que la competencia sea justa, las jugadas de todos los participantes se revelan cuando se cierran las inscripciones.
            </p>
            <div className="rounded-xl p-3 inline-block"
              style={{ background: 'rgba(200,170,110,0.08)', border: '1px solid rgba(200,170,110,0.2)' }}>
              <div className="text-xs font-bold" style={{ color: 'rgba(210,185,130,0.6)' }}>Se revelan el</div>
              <div className="font-condensed text-lg font-black" style={{ color: '#C8AA6E' }}>
                9 de junio · 17:00hs (ARG)
              </div>
            </div>
            <div className="mt-4 text-xs" style={{ color: 'rgba(210,185,130,0.4)' }}>
              {jugadas.length} jugada{jugadas.length !== 1 ? 's' : ''} registrada{jugadas.length !== 1 ? 's' : ''} en este grupo
            </div>
          </div>
        )}
